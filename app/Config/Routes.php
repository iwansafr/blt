...
$routes->get('/blt/desa', 'BltController::list/1');
$routes->get('/blt/kecamatan', 'BltController::list/2');
$routes->get('/blt/dinsos', 'BltController::list/3');
$routes->get('/blt/provinsi', 'BltController::list/4');
$routes->get('/blt/kementerian', 'BltController::list/5');
